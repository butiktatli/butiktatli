...
(() => {
  ...
  const I18N = {
    tr: {
      ...
      contact_h2: "İletişim",
      contact_sub: "Kayıt, fiyat ve program bilgisi için mesaj bırak. En kısa sürede geri döneceğiz.",
      ...
      label_message: "Mesaj",
      ph_message: "Kısaca ne istediğini yaz (ör: Makaron kursu almak istiyorum)...",
    ...
    en: {
      ...
      contact_h2: "Contact",
      contact_sub: "Leave a message for enrollment, pricing and schedule. We'll get back to you shortly.",
  ...
  form?.addEventListener("submit", async (e) => {
    ...
    // Sync _replyto ve _subject hidden alanlarını doldur
    ...
    // Submit butonu devre dışı bırak
    ...
    try {
      ...
      if (res.ok) {
        ...
        const errMsg = data?.errors?.[0]?.message || "Gönderim başarısız, lütfen tekrar deneyin.";
        showToast(errMsg);
      }
    } catch (_) {
