...
(() => {
  ...
  const I18N = {
    tr: {
      ...
      reviews_sub:    "150 Google yorumunda 5 yıldızla değerlendiriliyoruz.",
      reviews_badge:  "Google Doğrulamalı",
      reviews_count:  "150 yorum",
      reviews_cta:    "Tüm Yorumları Google'da Gör",
      reviews_all:    "Tüm 150 Yorumu Google'da Gör",
    ...
    en: {
      ...
      reviews_sub:    "Rated 5 stars across 150 Google reviews.",
      reviews_badge:  "Google Verified",
      reviews_count:  "150 reviews",
      reviews_cta:    "See All Reviews on Google",
      reviews_all:    "See All 150 Reviews on Google",
